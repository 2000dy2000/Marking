...
export default defineConfig({
  shortcuts: {
    ...
    'bg-primary': 'bg-#11A0AE',
    'color-primary': 'text-light-blue-500 dark:text-light-blue-600',
    'border-primary': 'border-light-blue-500 dark:border-light-blue-600/80',
    'input-style': 'ml-25% mr-5% p-4px pl-11px bg-#f1f1f1 b-rd-8px',
  },
  presets: [
    presetIcons({
      scale: 1.2,
